...
{
	this->julianDayNumber_ = getJulianDayNumber(y,m,d);
}
...
{
	char buf[32];
	YearMonthDay ymd(this->yearMonthDay());
...
{
	return getYearMonthDay(this->julianDayNumber_);
}
